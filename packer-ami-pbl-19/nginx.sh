...
## commented out because nginx proxy is using an http protocol
...
# -subj "/C=US/ST=Virginia/L=Northern Virginia/O=goddhi/OU=Dev/CN=$(curl -s http://169.254.169.254/latest/meta-data/local-hostname)"
